...
public class PurpleHazeRenderer extends ExtendedStandEntityRenderer<AbstractPurpleHazeEntity<?, ?>> {
    ...
    @Override
    public RenderLayer getRenderType(AbstractPurpleHazeEntity<?,?> animatable, float partialTicks, MatrixStack stack,
    ...
    @Override
    public void renderEarly(AbstractPurpleHazeEntity<?,?> animatable, MatrixStack poseStack, float partialTick, VertexConsumerProvider bufferSource, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float partialTicks) {
    ...
    @Override
    public void render(GeoModel model, AbstractPurpleHazeEntity<?,?> animatable, float tickDelta, RenderLayer type, MatrixStack matrixStackIn, VertexConsumerProvider renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
    ...
    @Override
    protected ItemStack getHeldItemForBone(String boneName, AbstractPurpleHazeEntity<?,?> currentEntity) {
    ...
    @Override
    protected void preRenderItem(MatrixStack stack, ItemStack item, String boneName, AbstractPurpleHazeEntity<?,?> currentEntity, IBone bone) {
