...
public class JRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        // stand arrowhead
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.STAND_ARROWHEAD, 3)
                .pattern("NGI")
                .pattern("GIG")
                .pattern(" GN")
                ...
                .offerTo(exporter);
        // stand arrow
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.STANDARROW)
                .pattern("  A")
                .pattern(" S ")
                .pattern("F  ")
                ...
                .offerTo(exporter);
        // stand disk
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.STAND_DISC)
                .pattern("FFF")
                .pattern("FAF")
                .pattern("FFF")
                ...
                .offerTo(exporter);
        // sinner's soul
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.SINNERSSOUL)
                .pattern("SSS")
                .pattern("SFS")
                .pattern("SSS")
                ...
                .offerTo(exporter);
        // living arrow
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.LIVINGARROW)
                ...
                .offerTo(exporter);
        // soul block
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.SOUL_BLOCK)
                .input(JObjectRegistry.SINNERSSOUL)
                .input(JObjectRegistry.SINNERSSOUL)
                .input(JObjectRegistry.SINNERSSOUL)
                .input(JObjectRegistry.SINNERSSOUL)
                ...
                .offerTo(exporter);
        // requiem ruby
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.REQUIEMRUBY)
                .pattern("RDR")
                .pattern("ENE")
                .pattern("RDR")
                ...
                .offerTo(exporter);
        // requiem arrow
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.REQUIEMARROW)
                .input(JObjectRegistry.STANDARROW)
                ...
                .offerTo(exporter);
        // coffin
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.COFFIN_BLOCK)
                .pattern("SSS")
                .pattern("SBS")
                ...
                .offerTo(exporter);
        // Kars' headwrap
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.KARSHEADWRAP)
                .pattern(" C ")
                .pattern("L L")
                .pattern(" B ")
                ...
                .offerTo(exporter);
        // red hat
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.RED_HAT)
                .pattern(" R ")
                .pattern("LCL")
                .input('C', Items.LEATHER_HELMET)
                .input('L', Items.LEATHER)
                ...
                .offerTo(exporter);
        // blood bottle
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.BLOOD_BOTTLE)
                .pattern(" B ")
                .pattern(" G ")
                .pattern("GGG")
                ...
                .offerTo(exporter);
        // Jotaro's cap
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.JOTAROCAP)
                .pattern("BYB")
                .pattern("BHB")
                .input('B', Items.BLACK_DYE)
                ...
                .offerTo(exporter);
        // Jotaro's jacket
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.JOTAROJACKET)
                .pattern("B B")
                .pattern("BCB")
                .pattern("BBB")
                .input('B', Items.BLACK_DYE)
                ...
                .offerTo(exporter);
        // Jotaro's pants
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.JOTAROPANTS)
                .pattern("YYY")
                .pattern("BLB")
                .pattern("B B")
                .input('B', Items.BLACK_DYE)
                ...
                .offerTo(exporter);
        // Jotaro's boots
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.JOTAROBOOTS)
                .pattern("BNB")
                .pattern("B B")
                .input('B', Items.BLACK_DYE)
                ...
                .offerTo(exporter);
        // Dio's headband
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.DIOHEADBAND)
                .pattern("GHG")
                ...
                .offerTo(exporter);
        // Dio's jacket
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.DIOJACKET)
                .pattern("Y Y")
                .pattern("YCY")
                .pattern("YBY")
                .input('B', Items.BLACK_DYE)
                ...
                .offerTo(exporter);
        // Dio's cape
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.DIOCAPE)
                .pattern("RLR")
                .pattern("LCL")
                .pattern("LLL")
                .input('C', Items.NETHERITE_CHESTPLATE)
                ...
                .offerTo(exporter);
        // Dio's pants
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.DIOPANTS)
                .pattern("GGG")
                .pattern("YLY")
                .pattern("Y Y")
                .input('G', Items.GREEN_DYE)
                ...
                .offerTo(exporter);
        // Dio's boots
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.DIOBOOTS)
                .pattern("YBY")
                .pattern("Y Y")
                ...
                .offerTo(exporter);
        // Dio's diary
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, JObjectRegistry.DIOSDIARY)
