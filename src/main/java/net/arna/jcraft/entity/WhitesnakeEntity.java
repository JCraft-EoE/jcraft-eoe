...
public class WhitesnakeEntity extends StandEntity implements IAnimatable, IAnimationTickable {
    ...
    public static Attack light = new Attack(2, 0.75f, 14, 7, 1.5, 5f, 0.75f, AttackType.BOX, 0.6f, 0.2f, 0, ModSoundRegister.IMPACT_3)
            .setInfo("Punch", "quick combo starter");
    public static Attack legcrusher = new Attack(20, 0.75f, 22, 16, 1.5, 5f, 0.25f, AttackType.BOX, 1.6f, 0.2f, 0, ModSoundRegister.TW_KICK_HIT).setHitspark(2)
    ...
    public static Attack barrage = new Attack(17, 0.75f, 60, 0, 2, 1f, 0.25f, AttackType.BARRAGE, 1, 0, 3, ModSoundRegister.IMPACT_3)
            .setInfo("Barrage", "fast reliable combo starter/extender, medium stun");
    public static Attack donut = new Attack(18, 1f, 36, 17, 2, 12f, 0.0f, AttackType.BOX, 1.4f, 0, 0, ModSoundRegister.TW_DONUT_HIT).setHitspark(2)
            .setInfo("Donut", "slow combo starter/extender");
    public static Attack memorydisk = new Attack(45, 1f, 34, 22, 2, 6f, 0.0f, AttackType.BOX, 1f, 0, 0, ModSoundRegister.IMPACT_2).setHitspark(2).setArmor(true)
            .setUB(true)
            .setInfo("Memory Disk", "uninterruptable, mining fatigue & weakness for 30s");
    public static Attack standdisk = new Attack(36, 1f, 34, 22, 2, 6f, 0.0f, AttackType.BOX, 1f, 0, 0, ModSoundRegister.IMPACT_2).setArmor(true)
            .setUB(true)
    ...
    public void InitBarrage() {
        ...
        if (HandleAttack(barrage, JCraft.standBarrageCD, 5)) {
            this.playSound(ModSoundRegister.WS_BARRAGE,1, 1);
        }
    }
    ...
    public void InitHeavyAttack() {
        ...
        if (HandleAttack(donut, JCraft.standHeavyCD, 4)) {
            this.playSound(ModSoundRegister.WS_DONUT,1, 1);
        }
    }
    ...
    public void InitSpecial1() {
        ...
        if (HandleAttack(standdisk, JCraft.standS1CD, 8)) {
            this.playSound(ModSoundRegister.WS_DISK,1, 1);
        }
    }
    ...
    public void InitSpecial2() {
        ...
        if (HandleAttack(legcrusher, JCraft.standS2CD, 6)) {
            this.playSound(ModSoundRegister.WS_LEGCRUSH,1, 1);
        }
    }
        ...
        if (attack == poisonspew) {
            if (!world.isClient()) {
                for (LivingEntity ent : entities) {
                    ent.addStatusEffect(new StatusEffectInstance(ModStatusRegister.WSPoison, 80, 1));
                }
            ...
            for (LivingEntity ent : entities) {
                ent.addStatusEffect(new StatusEffectInstance(ModStatusRegister.Standless, 160, 0, true, false));
            }
            ...
            this.playSound(ModSoundRegister.WS_GUN, 1, 1);
