...
public class SilverChariotEntity extends StandEntity implements IAnimatable, IAnimationTickable {
    ...
    public Attack realbeatdown = new Attack(0, 0.65f, 59, 0, 2.0, 3.5f, 0.75f, AttackType.MULTIHIT, 1.1f, 0, List.of(1, 6, 13, 14, 24, 36, 56), ModSoundRegister.IMPACT_1);
    ...
    public void setMode(int m) { this.dataTracker.set(MODE, m); }
    ...
    public void InitHeavyAttack() {
        ...
        if (HandleAttack(this.heavy, JCraft.standHeavyCD, 4)) {
            this.playSound(ModSoundRegister.SC_HEAVY,1, 1);
        }
    }
    ...
    public void InitBarrage() {
        ...
        if (HandleAttack(this.barrage, JCraft.standBarrageCD, 5)) {
            this.playSound(ModSoundRegister.SC_BARRAGE,1, 1);
        }
    }
    ...
    public void InitSpecial1() {
        ...
        if (HandleAttack(this.spinbarrage, JCraft.standS1CD, 6)) {
            this.playSound(ModSoundRegister.SC_SPIN,1, 1);
        }
    }
    ...
    public void InitSpecial2() {
        ...
        if (this.getMode() == 3) {
            ...
            if (HandleAttack(this.charge, JCraft.standS2CD, 7)) {
                ...
                this.playSound(ModSoundRegister.SC_CHARGE,1, 1);
            }
        }
    }
    ...
    @Override
    public void tick() {
        if (age == 1) { this.world.playSound(null, this.getX(), this.getY(), this.getZ(), ModSoundRegister.SC_SUMMON, SoundCategory.PLAYERS, 1f, 1f); }
        super.tick();
