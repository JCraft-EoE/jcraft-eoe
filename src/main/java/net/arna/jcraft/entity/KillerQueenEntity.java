...
public class KillerQueenEntity extends StandEntity implements IAnimatable, IAnimationTickable {
    ...
    public static Attack heavy = new Attack(12, 0.75f, 24, 16, 2, 9f, 1.75f, AttackType.BOX, 0.5f, 0, 0, ModSoundRegister.IMPACT_4).setHitspark(2).setArmor(true).setLaunch()
    ...
    public void InitHeavyAttack() {
        ...
        if (HandleAttack(heavy, JCraft.standHeavyCD, 4)) {
            ...
            this.playSound(ModSoundRegister.KQ_HEAVY,1, 1);
        }
    }
    ...
    public void SpecialAttack(Attack attack, List<LivingEntity> entities) {
        ...
        if (attack == bombplant) {
            ...
            SheerHeartAttackEntity sha = new SheerHeartAttackEntity(ModEntityRegister.SHA, world);
            sha.setOwner(user);
