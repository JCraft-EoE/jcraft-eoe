...
public class StarPlatinumEntity extends StandEntity implements IAnimatable, IAnimationTickable {
    ...
    public void InitSpecial1() {
        ...
        if (HandleAttack(starfinger, JCraft.standS1CD, 6)) {
            this.playSound(ModSoundRegister.STAR_FINGER,1, 1);
        }
    }
    ...
    public void InitSpecial2() {
        ...
        if (HandleAttack(lowkick, JCraft.standS2CD, 8)) {
            this.playSound(ModSoundRegister.STAR_PLATINUM_KICK,1, 1);
        }
    }
    ...
    public void InitSpecial3() {
        ...
        if (HandleAttack(chargebarrage, JCraft.standS3CD, 5)) {
            this.playSound(ModSoundRegister.STAR_PLATINUM_ADVANCING_BARRAGE,1, 1);
        }
    }
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {AnimationController controller = event.getController();
        ...
        if (age < 15 && getState() < 2) { controller.setAnimation(builder.playOnce("animation.starplatinum.summon")); return PlayState.CONTINUE; }
