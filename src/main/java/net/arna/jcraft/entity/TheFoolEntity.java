...
public class TheFoolEntity extends StandEntity implements IAnimatable, IAnimationTickable {
    ...
    public static Attack light = new Attack(2, 1.5f, 14, 7, 2, 6f, 0.8f, AttackType.BOX, 0.75f, -0.1f, 0, ModSoundRegister.IMPACT_2)
    ...
    public static Attack combo = new Attack(17, 1.5f, 31, 0, 1.75, 4.5f, 0.1f, AttackType.MULTIHIT, 1f, -0.1f, List.of(8, 16, 20, 21), ModSoundRegister.IMPACT_2)
            .setInfo("3-hit combo (grounded) / Burn Rubber (aerial)", "knockdown on final hit / slows down all movement, combo starter/extender");
    public static Attack launch = new Attack(16, 1.25f, 20, 16, 2, 8f, 0.5f, AttackType.BOX, 1.25f, -0.3f, 0, ModSoundRegister.IMPACT_2).setHitspark(2).setArmor(true)
            .setInfo("Launch", "uninterruptable, slow, launching uppercut");
    public static Attack pound = new Attack(24, 1.25f, 23, 0, 1.5, 4f, 0.1f, AttackType.MULTIHIT, 1.25f, -0.1f, List.of(7, 15), ModSoundRegister.IMPACT_2).setLift(false)
    ...
    public static Attack charge = new Attack(22, 5f, 22, 5, 1.5, 6f, 1.2f, AttackType.CHARGE, 0.5f, 0, 11, ModSoundRegister.IMPACT_2).setRanged(true).setLaunch()
            .setInfo("Charge", "The Fool detaches from the user and charges forward, dealing knockback on hit");
    public static Attack sandstorm = new Attack(50, 1.5f, 41, 28, 2, 7f, 0.1f, AttackType.BOX, 1, 0, 0, ModSoundRegister.TW_KICK_HIT).setHitspark(2)
            .setUB(true)
    ...
    private ArrayList<FallingBlockEntity> sands = new ArrayList<>();
    ...
    public boolean isSand() { return this.dataTracker.get(ISSAND); }
    public void setSand(boolean b) { this.dataTracker.set(ISSAND, b); }
    public boolean isWave() { return this.dataTracker.get(ISWAVE); }
    public void setWave(boolean b) { this.dataTracker.set(ISWAVE, b); }
    ...
    public void InitHeavyAttack() {
        ...
        if (HandleAttack(launch, JCraft.standHeavyCD, 6)) {
            this.setSand(true);
            this.playSound(ModSoundRegister.FOOL_LAUNCH,1, 1);
        }
    }
    ...
    public void InitSpecial1() {
        ...
        if (HandleAttack(pound, JCraft.standS1CD, 7)) {
            this.playSound(ModSoundRegister.FOOL_BARK2,1, 1);
        }
    }
    ...
    public void InitUlt() {
        ...
        if (HandleAttack(sandstorm, JCraft.standUltCD, 12)) {
            this.playSound(ModSoundRegister.FOOL_CHARGE,1, 1);
        }
    }
    ...
    public void InitMiddleClick() {
        ...
        if (HandleAttack(sandwave, JCraft.standMMBCD, 10)) {
            ...
            this.playSound(ModSoundRegister.FOOL_BARK1,1, 1);
        }
    }
    ...
    public void Desummon() {
        ...
        if ( this.sandClone != null ) { this.sandClone.kill(); }
    ...
    public void SpecialAttack(Attack attack, List<LivingEntity> entities) {
        ...
        if (attack == sandwave) {
            for (LivingEntity ent : entities) {
                ent.addStatusEffect(new StatusEffectInstance(ModStatusRegister.Knockdown, 15, 0));
            }
            ...
            for (LivingEntity ent : entities) {
                ent.addStatusEffect(new StatusEffectInstance(ModStatusRegister.Knockdown, 20, 0));
            }
