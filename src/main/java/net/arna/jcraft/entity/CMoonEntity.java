...
public class CMoonEntity extends StandEntity implements IAnimatable, IAnimationTickable {
    ...
    public static Attack barrage = new Attack(17, 0.75f, 60, 0, 2, 1f, 0.25f, AttackType.BARRAGE, 1, 0, 4, ModSoundRegister.IMPACT_3)
            .setInfo("Barrage", "fast reliable combo starter/extender/finisher, medium stun");
    public static Attack gutpunch = new Attack(17, 1f, 30, 19, 2.0, 10f, 1.5f, AttackType.BOX, 0.5f, 0, 0, ModSoundRegister.TW_KICK_HIT).setHitspark(2).setArmor(true).setLaunch()
    ...
    public static Attack gravpunch = new Attack(24, 1f, 32, 20, 1.75, 8f, 0.35f, AttackType.BOX, 1.75f, -0.3f, 0, ModSoundRegister.CMOON_GRAVPUNCHHIT).setHitspark(2).setArmor(true)
            .setUB(true)
            .setInfo("Only One Punch", "lifts enemy on hit");
    public static Attack groundslam = new Attack(28, 1f, 18, 10, 3, 7f, 0.2f, AttackType.BOX, 0.85f, 1.4f, 0, ModSoundRegister.CMOON_GRAVPUNCHHIT)
            .setUB(true)
    ...
    public void InitHeavyAttack() {
        ...
        if (HandleAttack(gutpunch, JCraft.standHeavyCD, 4)) {
            this.playSound(ModSoundRegister.CMOON_DONUT,1, 1);
        }
    }
    ...
    public void InitSpecial1() {
        ...
        if (HandleAttack(gravpunch, JCraft.standS1CD, 6)) {
            this.playSound(ModSoundRegister.CMOON_GRAVPUNCH,1, 1);
        }
    }
    ...
    public void InitUlt() {
        ...
        if (HandleAttack(gravshift, JCraft.standUltCD, 10)) {
            this.playSound(ModSoundRegister.CMOON_GRAVSHIFT,1, 1);
        }
    }
    ...
    public void InitSpecial3() {
        ...
        if (HandleAttack(groundslam, JCraft.standS3CD, 7)) {
            this.playSound(ModSoundRegister.CMOON_GROUNDSLAM,1, 1);
        }
    }
