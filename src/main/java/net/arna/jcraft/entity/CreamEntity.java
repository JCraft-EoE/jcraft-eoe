...
public class CreamEntity extends StandEntity implements IAnimatable, IAnimationTickable {
    ...
    public static Attack light = new Attack(2, 0.75f, 14, 6, 1.5, 5f, 0.75f, AttackType.BOX, 1f, 0.1f, 0, ModSoundRegister.IMPACT_3)
            .setInfo("Punch", "quick combo starter");
    public static Attack heavy = new Attack(14, 1f, 30, 20, 1.5, 10f, 0.1f, AttackType.BOX, 2, 0, 0, ModSoundRegister.IMPACT_3).setHitspark(2).setArmor(true)
            .setInfo("Vertical Chop", "slow, uninterruptable combo starter");
    public static Attack combo = new Attack(17, 0.75f, 36, 0, 2.0, 7f, 0.1f, AttackType.MULTIHIT, 1, 0, List.of(10, 17, 25), ModSoundRegister.IMPACT_3)
    ...
    public static Attack charge = new Attack(20, 4f, 13, 5, 1.5, 8f, 0.25f, AttackType.CHARGE, 1, 0, 8, ModSoundRegister.IMPACT_3).setRanged(true)
    ...
    public static Attack destroy = new Attack(25, 1f, 30, 21, 2, 0f, 1.25f, AttackType.BOX, 0f, 0f, 0, ModSoundRegister.IMPACT_5).setHitspark(2).setArmor(true)
            .setUB(true)
    ...
    public static Attack balllight = new Attack(2, 0f, 14, 7, 2, 5f, 0.75f, AttackType.BOX, 1f, 0.2f, 0, ModSoundRegister.IMPACT_3)
            .setInfo("Swipe", "quick air-to-ground poke");
    public static Attack ballheavy = new Attack(14, 0f, 20, 14, 2, 9f, 1.25f, AttackType.BOX, 0.75f, 0.3f, 0, ModSoundRegister.TW_KICK_HIT)
    ...
    public boolean getHalfBall() { return this.dataTracker.get(HALFBALL); }
    ...
    public int getVoidTime() { return this.dataTracker.get(VOIDTIME); }
    public void setVoidTime(int vTime) { this.dataTracker.set(VOIDTIME, vTime); }
    ...
    public void InitHeavyAttack() {
        ...
        if (getHalfBall()) {
            if (HandleAttack(ballheavy, JCraft.standHeavyCD, 4)) {
                this.playSound(ModSoundRegister.CREAM_SMASH,1, 1);
            }
        } else if (HandleAttack(heavy, JCraft.standHeavyCD, 4)) {
            this.playSound(ModSoundRegister.CREAM_HEAVY,1, 1);
        }
    }
    ...
    public void InitBarrage() {
        ...
        if (getHalfBall()) { //TODO: half-ball barrage
            ...
            this.playSound(ModSoundRegister.CREAM_COMBO,1, 1);
        }
    }
    ...
    public void InitUlt() {
        ...
        if (HandleAttack(consume, JCraft.standUltCD, 6)) {
            this.playSound(ModSoundRegister.CREAM_CONSUME,1, 1);
        }
    }
    ...
    public void InitSpecial1() {
        ...
        if (getHalfBall()) { //TODO: half-ball Grab
            ...
            this.playSound(ModSoundRegister.CREAM_GRAB,1, 1);
        }
    }
    ...
    public void InitSpecial2() {
        ...
        if (getHalfBall()) { //TODO: Surge
            ...
            this.playSound(ModSoundRegister.CREAM_CHARGE,1, 1);
        }
    }
    ...
    public void InitMiddleClick() {
        ...
        if (getHalfBall()) {
            if (HandleAttack(exit, JCraft.standMMBCD, 12))
                this.playSound(ModSoundRegister.CREAM_EXIT, 1, 1);
        } else {
            if (HandleAttack(enter, JCraft.standMMBCD, 11))
                this.playSound(ModSoundRegister.CREAM_ENTER, 1, 1);
        }
    }
    ...
    public void Desummon() {
        ...
        if (this.getVoidTime() > 0) { this.setVoidTime(0); return; }
    ...
    public void tick() {
        ...
        if (hasUser()) {
            ...
            if (server) {
                if (this.curAttack != null) { this.setVoidTime(0); }
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        ...
        if (age < 20 && !getHalfBall() && getState() < 2) { controller.setAnimation(builder.playOnce("animation.cream.summon")); return PlayState.CONTINUE; }
