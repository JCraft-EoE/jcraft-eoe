...
public class MadeInHeavenEntity extends StandEntity implements IAnimatable, IAnimationTickable {
    ...
    public static Attack legcrusher = new Attack(16, 0.75f, 17, 8, 1.25, 7f, 0.25f, AttackType.BOX, 1.5f, 0.2f, 0, ModSoundRegister.TW_KICK_HIT)
            .setInfo("Leg Crusher", "combo starter/extender, mih hoofs the enemies legs in a quick, stunning attack");
    public static Attack furychop  = new Attack(19, 0.75f, 24, 15, 1.6, 7f, 0.25f, AttackType.BOX, 1f, 0.2f, 0, ModSoundRegister.IMPACT_2).setHitspark(2)
    ...
    public static Attack donut  = new Attack(23, 0.75f, 32, 26, 2.2, 8.5f, 0.0f, AttackType.BOX, 3f, 0.2f, 0, ModSoundRegister.IMPACT_4).setArmor(true).setHitspark(2)
    ...
    public void InitUlt() {
        ...
        if (HandleAttack(timeaccel, JCraft.standUltCD, 10)) {
            this.playSound(ModSoundRegister.MIH_TACCEL,1, 1);
        }
    }
    ...
    public void InitSpecial2() {
        ...
        if (HandleAttack(furychop, JCraft.standS2CD, 9)) {
            this.playSound(ModSoundRegister.MIH_FURYCHOP,1, 1);
        }
    }
    ...
    public void InitSpecial3() {
        ...
        if (HandleAttack(judgement, JCraft.standS3CD, 7)) {
            this.playSound(ModSoundRegister.MIH_JUDGEMENT,1, 1);
        }
    }
    ...
    public void InitMiddleClick() {
        ...
        if (HandleAttack(speedslice, JCraft.standMMBCD, 6)) {
            this.playSound(ModSoundRegister.MIH_SPEEDSLICE,1, 1);
        }
    }
    ...
    private static final Attack barrageFinisher = new Attack(17, 0.85f, 9, 6, 1.5, 1f, 1.1f, AttackType.BOX, 0.5f, 0, 0, ModSoundRegister.TW_KICK_HIT).setHitspark(2).setLaunch();
    @Override
    ...
    private void SpeedSlice(LivingEntity player, Vec3d start, Vec3d destination, float damage, float kb, double size) {
        ...
        this.playSound(ModSoundRegister.MIH_ZOOM, 1f, 1f);
    }
