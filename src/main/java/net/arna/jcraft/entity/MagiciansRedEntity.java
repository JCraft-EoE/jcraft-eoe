...
public class MagiciansRedEntity extends StandEntity implements IAnimatable, IAnimationTickable {
    ...
    public static Attack light = new Attack(2, 0.75f, 8, 5, 1.5, 5f, 0.75f, AttackType.BOX, 0.75f, -0.1f, 0, ModSoundRegister.IMPACT_1)
            .setInfo("Punch", "quick combo starter");
    public static Attack heavy = new Attack(17, 1f, 22, 12, 1.75, 7f, 0.5f, AttackType.BOX, 0, 0.6f, 0, ModSoundRegister.TW_KICK_HIT)
    ...
    public static Attack redbind = new Attack(20, 0.75f, 22, 12, 1.5, 5, 0, AttackType.BOX, 0.75f, 0, 0, ModSoundRegister.IMPACT_3)
            ...
            if (attack == barrage) {
                ...
                for (LivingEntity ent : entities) {
                    if (!JCraftUtils.isBlocking(ent)) {
                        ent.addStatusEffect(new StatusEffectInstance(ModStatusRegister.Knockdown, 40, 0));
                    }
                }
                    ...
                    if (hurricaneTime > 0) {
                        ...
                        for (LivingEntity livingEntity : toHurt) {
                            if (hurricaneTime > 1) {
                                ...
                                if (hurricaneTime > 15) { hurricaneTime = 15; } // Allows for zoning up until it hits something
                            } else {
                                livingEntity.addStatusEffect(new StatusEffectInstance(ModStatusRegister.Knockdown, 20, 0));
                            }
                        }
