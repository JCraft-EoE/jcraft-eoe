...
public class KnockdownStatusEffect extends StatusEffect {
    ...
    public KnockdownStatusEffect() { super(StatusEffectCategory.NEUTRAL, 0x444444); }
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        StatusEffectInstance self = entity.getStatusEffect(ModStatusRegister.Knockdown);
        ...
        } else { entity.setPose(EntityPose.STANDING); entity.removeStatusEffect(ModStatusRegister.Dazed); }
    }
}