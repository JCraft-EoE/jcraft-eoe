...
public class FVRevolverItem extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!world.isClient()) {
            ...
            world.playSound(null, user.getX(), user.getY(), user.getZ(), ModSoundRegister.REVOLVER_FIRE, SoundCategory.PLAYERS, 1f, 1f);
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        if ( (stack.getMaxDamage() - stack.getDamage()) <= 0 ) { stack.decrement(1); }
