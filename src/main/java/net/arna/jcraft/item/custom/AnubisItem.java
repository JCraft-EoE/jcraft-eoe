...
import static net.arna.jcraft.entity.StandEntity.BaseDamageLogic;
...
public class AnubisItem extends Item {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        if (attacker instanceof PlayerEntity player) {
            ...
            if (attacker.isSneaking()) {
                ...
                if (pData.getInt(JCraft.standBarrageCD) < 40) { pData.putInt(JCraft.standBarrageCD, 40); }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!user.isSneaking()) {
            ...
            user.setStackInHand(hand, new ItemStack(ModItemRegister.ANUBISSHEATHED));
        }
