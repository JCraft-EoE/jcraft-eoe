...
public class VampireSpec extends JSpec<VampireSpec, VampireSpec.State> {
    public static final UppercutAttack<VampireSpec> SWEEP = new UppercutAttack<VampireSpec>(10, 6,
            12, 1f, 5f, 12, 1.5f, 0.5f, 0.5f, 0.5f)
            .withImpactSound(JSoundRegistry.IMPACT_1)
            .withStaticY()
            .withInfo(Text.literal("Sweep Kick"), Text.literal("fast launcher"));
    public static final SimpleAttack<VampireSpec> ROUNDHOUSE = new SimpleAttack<VampireSpec>(10, 8,
    ...
    public static final SimpleMultiHitAttack<VampireSpec> COMBO = new SimpleMultiHitAttack<VampireSpec>(400,
