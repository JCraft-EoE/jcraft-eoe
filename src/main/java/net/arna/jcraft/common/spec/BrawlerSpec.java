...
public class BrawlerSpec extends JCraftSpec {
    ...
    public static final Attack combo = new Attack(1, 22, 1f, 26, 0, 1.5, 4f, 0.6f, AttackType.MULTIHIT, 0.75f, -0.1f, List.of(5, 10, 19), JSoundRegistry.IMPACT_2)
            .setAnimation("br.3hit")
            .setInfo("Combo", "hits 3 times, combo starter/extender");
    public static final Attack gut = new Attack(2, 20, 1f, 18, 11, 1.5, 6f, 0.8f, AttackType.BOX, 0.80f, 0, 0, JSoundRegistry.IMPACT_2)
            .setAnimation("br.gut")
            .setHitspark(2)
            .setInfo("Gut Punch", "good stun", AttackQueue.SPECIAL1);
    public static final Attack low = new Attack(3, 20, 1f, 18, 11, 1.5, 5f, 0.6f, AttackType.BOX, 0.80f, 1, 0, JSoundRegistry.IMPACT_2)
            .setAnimation("br.low")
