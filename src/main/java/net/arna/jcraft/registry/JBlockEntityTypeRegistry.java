...
public interface JBlockEntityTypeRegistry {
    ...
    BlockEntityType<ShaderTestBlockEntity> SHADER_TEST_BLOCK_ENTITY = register("beam", FabricBlockEntityTypeBuilder.create(ShaderTestBlockEntity::new, JObjectRegistry.SHADER_TEST_BLOCK).build(null));
