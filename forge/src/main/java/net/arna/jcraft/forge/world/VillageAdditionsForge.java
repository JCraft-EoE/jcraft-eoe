package net.arna.jcraft.forge.world;

import com.mojang.datafixers.util.Pair;
import net.arna.jcraft.JCraft;
import net.arna.jcraft.forge.mixin.StructureTemplatePoolAccessor;
...
@Mod.EventBusSubscriber(modid = JCraft.MOD_ID)
public class VillageAdditionsForge {
    ...
    public static void addNewVillageBuilding(final ServerAboutToStartEvent event) {
        ...
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                ...
                "jcraft:boxing_arena/boxing_area", 1000);
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
