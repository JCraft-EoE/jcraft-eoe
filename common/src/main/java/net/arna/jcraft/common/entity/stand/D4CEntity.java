...
public class D4CEntity extends StandEntity<D4CEntity, D4CEntity.State> {
    ...
    public static final ItemPlaceMove<D4CEntity> ITEM_PLACE = new ItemPlaceMove<D4CEntity>(JCraft.LIGHT_COOLDOWN, 8, 12, 0.75f)
            ...
            .withInfo(
                    ...
                    Component.literal("Places an item from an Alternate Universe on the ground, which attracts other such items and explodes on contact with them.")
            );
    ...
    public static final SimpleAttack<D4CEntity> CHOP_FOLLOWUP = new SimpleAttack<D4CEntity>(0,
            9, 14, 0.75f, 7f, 8, 1.75f, 1.25f, -0.1f)
            .withAnim(State.MEDIUM_FOLLOWUP)
    ...
    public static final SimpleAttack<D4CEntity> CHOP = new SimpleAttack<D4CEntity>(0,
            9, 16, 0.75f, 6f, 20, 1.66f, 0.4f, -0.1f)
            .withFollowupFrame(7)
            .withFollowup(CHOP_FOLLOWUP)
            .withCrouchingVariant(CHARGE)
            .withImpactSound(JSoundRegistry.IMPACT_2)
            .withHitAnimation(CommonHitPropertyComponent.HitAnimation.CRUSH)
            .withInfo(
                    Component.literal("Heavy Chop"),
                    Component.literal("Slow combo starter. High stun.")
            );

    public static final SimpleAttack<D4CEntity> LIGHT_FOLLOWUP = new SimpleAttack<D4CEntity>(0,
            7, 12, 0.75f, 5f, 7, 1.5f, 1.0f, 0.0f)
            .withAnim(State.LIGHT_FOLLOWUP)
            .withImpactSound(JSoundRegistry.IMPACT_1)
            .withHitAnimation(CommonHitPropertyComponent.HitAnimation.MID)
            .withInfo(
                    Component.literal("Elbow Strike"),
                    Component.literal("Brief combo finisher. Doesn't launch, unlike most Light followups.")
            );
    public static final SimpleAttack<D4CEntity> LIGHT = new SimpleAttack<D4CEntity>(JCraft.LIGHT_COOLDOWN,
            7, 12, 0.75f, 4.5f, 14, 1.5f, 0.25f, -0.1f)
            .noLoopPrevention()
    ...
    public static final DimensionalHopMove<D4CEntity> DIM_HOP = new DimensionalHopMove<D4CEntity>(1200, 40, 60,
            ...
            .withInfo(
                    ...
                    Component.literal("Travels to the Alternate Universe at your current exact coordinates.")
            );
    public static final GiveGunMove GIVE_GUN = new GiveGunMove(280, 10, 14, 0.75f)
            ...
            .withInfo(
                    ...
                    Component.literal("Gives the user a temporary Revolver.")
            );
    ...
    private static void registerMoves(MoveMap<D4CEntity, State> moves) {
        ...
        moves.registerImmediate(MoveClass.HEAVY, CHOP, State.MEDIUM);
    ...
    public void queueMove(@Nullable MoveInputType type) {
        final AbstractMove<?, ? super D4CEntity> move = getCurrentMove();

        if (move != null && move.getMoveClass() == MoveClass.HEAVY && type == MoveInputType.HEAVY)
            return;
    ...
    */
    ...
    public enum State implements StandAnimationState<D4CEntity> {
        ...
        MEDIUM(Attacks.createAnimationCommand(JCraft.BASE_CONTROLLER, "animation.d4c.medium", AzPlayBehaviors.HOLD_ON_LAST_FRAME)),
        MEDIUM_FOLLOWUP(Attacks.createAnimationCommand(JCraft.BASE_CONTROLLER, "animation.d4c.medium_followup", AzPlayBehaviors.HOLD_ON_LAST_FRAME)),
