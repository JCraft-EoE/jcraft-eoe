...
public abstract class AbstractMove<T extends AbstractMove<T, A>, A extends IAttacker<? extends A, ?>> {
     ...
     * @return This move
     * @see #lookTrackingReach
     */
    public T withLookTrackingReach(final float lookTrackingReach) {
    ...
    protected @NonNull T copyExtras(final @NonNull T base) {
        ...
        cast.lookTracking = lookTracking;
        cast.lookTrackingReach = lookTrackingReach;
        copiedExtras = true;
        return base;
    }
