...
public class StormCloudRenderer extends AbstractEntityRenderer<StormCloudEntity> {
    ...
    public StormCloudRenderer(final @NonNull EntityRendererProvider.Context context) {
        super(context, () -> new EntityAnimator<>(JCraft.id("animations/weather_report.animation.json")), MODEL, TEXTURE);
    }

    @Override
    public boolean shouldShowName(final @NonNull StormCloudEntity animatable) {
        return false;
    }
}
