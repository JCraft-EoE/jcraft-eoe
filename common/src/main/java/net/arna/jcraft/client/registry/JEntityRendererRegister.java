...
public interface JEntityRendererRegister {
    ...
    RendererData<?>[] entries = {
            ...
            new RendererData<>(JEntityTypeRegistry.WEATHER_REPORT, context -> new StandEntityRenderer<>(context, JStandTypeRegistry.WEATHER_REPORT.get())),
            new RendererData<>(JEntityTypeRegistry.HAIL, context -> new ProjectileRenderer<>(context, "emerald")),
            new RendererData<>(JEntityTypeRegistry.ELECTRIC_BOLT, context -> new ProjectileRenderer<>(context, "bullet")),
            new RendererData<>(JEntityTypeRegistry.WEATHER_TORNADO, WeatherTornadoRenderer::new),
            new RendererData<>(JEntityTypeRegistry.WINTER_STORM, WinterStormRenderer::new),
            new RendererData<>(JEntityTypeRegistry.STORM_CLOUD, StormCloudRenderer::new),
            new RendererData<>(JEntityTypeRegistry.FROG_RAIN_CLOUD, FrogRainCloudRenderer::new),
            new RendererData<>(JEntityTypeRegistry.BLUE_POISON_FROG, GEFrogRenderer::new),
            new RendererData<>(JEntityTypeRegistry.WIND_GUST, JEntityRendererRegister::createEmpty),
            new RendererData<>(JEntityTypeRegistry.THROWN_FROG, context -> new ProjectileRenderer<>(context, "emerald")),
            new RendererData<>(JEntityTypeRegistry.CLOUD_PUFF, JEntityRendererRegister::createEmpty),
            ...
            new RendererData<>(JEntityTypeRegistry.FIRED_ICICLE, FiredIcicleRenderer::new),
