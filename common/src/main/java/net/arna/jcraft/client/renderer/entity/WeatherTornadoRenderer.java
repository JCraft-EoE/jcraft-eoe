...
public class WeatherTornadoRenderer extends AbstractEntityRenderer<WeatherTornadoEntity> {
    ...
    public WeatherTornadoRenderer(final @NonNull EntityRendererProvider.Context context) {
        super(context, () -> new EntityAnimator<>(JCraft.id("animations/weather_report.animation.json")), MODEL, TEXTURE);
    }

    @Override
    public boolean shouldShowName(final @NonNull WeatherTornadoEntity animatable) {
        return false;
    }
}
